...
function MedkitForm() {
    ...
    const onSubmit = async (data) => {
        console.log(data)
        try {
            const res = await axios.post("http://localhost:3000/api/orders/medkit/insert", data)
    ...
    return (
        ...
        >
            ...
            <div className='rounded-2xl shadow-xl flex justify-center flex-col w-1/2 mx-auto py-10 bg-white'>
                ...
                <h1 className='text-center font-bold text-2xl text-rose-500 mb-9'>MedKit Request Form</h1>
                ...
                <form action="" onSubmit={handleSubmit(onSubmit)} >
                    <div className='grid gap-3 mx-16'>
                        ...
                        <div className="">
                            <label className='quantity font-semibold'>Quantity</label> <br />
                            <input
                                type="number" placeholder='Enter your quantity'
                                className='outline-none py-1 px-2 w-full rounded border focus:border-2 focus:border-blue-600 my-2'
